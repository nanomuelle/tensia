...
_Última revisión: 2026-02-22 — Actualizado tras implementación US-11 (skeleton) y tests E2E TC-13_
...
| E2E | Playwright | `apps/frontend/tests/e2e/` | ✅ Implementado (29 tests, 4 flujos) |
...
- **Estado actual:** 142 tests, 8 suites — cobertura global > 70 % (objetivo cumplido)
...
- **Flujos cubiertos:**
  ...
  - TC-11: Banner de error si el almacenamiento local falla (localStorage bloqueado) — `error-backend.spec.js`
  - TC-13: Skeleton de gráfica cuando no hay datos suficientes (US-11) — `skeleton-grafica.spec.js`
